...
export default function SelfAuditPage() {
  ...
  return (
    <Page>
      <PageHeader title="Self Audit" description="PhantomScan continuously evaluates its own security posture." />
      ...
      {selfAudit && selfAudit.status !== 'never_run' ? (
        ...
        <EmptyState title="No self-audit data" description="Run a self-audit scan to evaluate PhantomScan's own posture." />
      )}
    </Page>
  );
}
