      ...
      <div className="w-full max-w-md">
        <div className="bg-[var(--surface-primary)] rounded-2xl border border-[var(--border-light)] p-8 shadow-[var(--shadow-float)]">
          <div className="text-center mb-8">
            ...
            <p className="text-[var(--text-muted)] mt-2">Start securing your applications with PhantomScan</p>
          </div>
          ...
          {supabaseConfigured && (
            <div className="space-y-3 mb-6">
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-2 bg-slate-900 rounded-[var(--radius-control)] px-4 py-2 text-xs font-semibold text-white hover:bg-slate-800 transition-all disabled:opacity-50 active:scale-[0.98]"
              >
