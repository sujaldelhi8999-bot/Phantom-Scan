      ...
      <div className="w-full max-w-md">
        <div className="bg-[var(--surface-primary)] rounded-2xl border border-[var(--border-light)] p-8 shadow-[var(--shadow-float)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-sm font-medium text-[var(--text-strong)] mb-1.5">
                Full Name (optional)
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-[var(--text-strong)] mb-1.5">
                Confirm Password
              </label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-[var(--text-muted)]" />
