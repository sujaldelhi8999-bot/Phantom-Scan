...
const tiers = [
  {
    ...
    description: 'For trying PhantomScan and scanning personal or open projects.',
...
export default function PricingPage() {
  ...
  const isProOrAdmin = user?.role === 'admin' || user?.subscriptionTier === 'PRO';
              ...
              >
                ...
                <div className="mt-8">
                  {isCurrentPlan ? (
                    ...
                    <a
                      href="mailto:sales@phantomscan.io"
