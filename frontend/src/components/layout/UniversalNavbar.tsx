    ...
    <header className="sticky top-0 z-40 border-b border-[var(--border-light)] bg-white/95 dark:bg-gray-900/95 backdrop-blur-md transition-colors shadow-xs">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 sm:px-6 py-2.5">
        ...
        <Link to="/" className="flex items-center gap-2.5 group">
          <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-[var(--brand)] shadow-sm group-hover:scale-105 transition-transform">
            <Shield className="h-4 w-4 text-white" />
          </span>
          <div className="flex flex-col">
            <span className="text-sm font-bold tracking-tight text-[var(--text-strong)] leading-none">PhantomScan</span>
